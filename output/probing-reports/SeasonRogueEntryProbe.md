...
- entryRows: 330
- descriptionRows: 331
- entriesWithBuffId: 330
- entriesWithLocalizedName: 330
- entriesWithDescriptionReference: 330
- entriesWithResolvedDescription: 330
- entriesWithDifficultyGate: 143
- nightmareOnlyEntries: 71
- hardAndNightmareEntries: 72
- genericEntryRows: 100
- advancedEntryRows: 230
- groups: 33
...
- 217 Stormblade - Iai Flash -> buff 3050180 [Hard+Nightmare]: Iaido Slash's CD is reduced by 50%, and Iaido Slash's Illusion-Breaking DMG is increased by 50%. Available only in [Hard] and [Nightmare].
...
- 219 Stormblade - Dragonfall Echo -> buff 3050200 [Nightmare]: Casting Dracoflash or Phantom Slash extends Volt Surge's duration by 10s. Dracoflash and Phantom Slash's Illusion-Breaking DMG is increased by 500%. Availabl...
- 220 Stormblade - Thunderclap Reset -> buff 3050210 [Nightmare]: During Volt Surge, Crits from Flash Strike and Raijin Dash will reset their CDs. Flash Strike and Raijin Dash's Illusion-Breaking DMG is increased by 50%. Av...
- 221 Stormblade - Lingering Thunder Cut -> buff 3050220 [Hard+Nightmare]: Thunder Cut's Movement Speed is reduced by 50%, and Thunder Cut's Illusion-Breaking DMG is increased by 60%. Available only in [Hard] and [Nightmare].
...
- 224 Stormblade - Stacking Divine Retribution -> buff 3050250 [Nightmare]: Increases Divine Sickle's max stacks by 7. Casting Divine Sickle consumes all stacks, increasing Illusion-Breaking DMG by 15% per stack. Available only in [N...
...
- 235 Frost Mage - Frigid Infusion -> buff 3052240 [Hard+Nightmare]: While in the Ultra Cold state, Frozen Gale gains the Permafrost effect, and its Illusion-Breaking DMG is increased by 200%. Available only in [Hard] and [Nig...
- 236 Frost Mage - Deca-Vortex -> buff 3052250 [Nightmare]: For every 10 times Frostbeam deals damage to the main target, it randomly triggers Water Vortex, Tidal Vortex, or Crystal Veil (if equipped). Frostbeam's Ill...
...
- 238 Frost Mage - Shatter Vortex -> buff 3052270 [Nightmare]: After its frozen explosion, Tidal Vortex splits into two new Tidal Vortexes (they will not split again). Tidal Vortex's Illusion-Breaking DMG is increased by...
...
- 244 Frost Mage - Triple Storm -> buff 3052170 [Hard+Nightmare]: Blizzard becomes an instant cast, and it summons three at once. Blizzard's Illusion-Breaking DMG is increased by 200%. Available only in [Hard] and [Nightmare].
- 245 Frost Mage - Final Meteor -> buff 3052180 [Nightmare]: Every 5 casts of Meteor Storm summons a meteor from the Ultimate, which instantly puts Blizzard on CD and reduces Permafrost's CD by 5s. The Ultimate's Illus...
...
- 260 Marksman - Charged Execution -> buff 3053290 [Nightmare]: Powerdraw Elemental Damage +100%. Deals +500% Illusion-Breaking DMG to targets with over 80% HP. Available only in [Nightmare].
...
- 266 Verdant Oracle - Instinctive Assault -> buff 3056250 [Hard+Nightmare]: Automatically triggers when Stag Charge is gained. Increases Special Attack's Illusion-Breaking DMG by 400%. Available only in [Hard] and [Nightmare].
- 267 Verdant Oracle - Scattering Infusion -> buff 3056260 [Nightmare]: Infusion fires additional bullets at 5 surrounding targets. Infusion's Illusion-Breaking DMG is increased by 100%. Available only in [Nightmare].
...
- 270 Verdant Oracle - Luck Stacks -> buff 3056290 [Hard+Nightmare]: When Infusion hits a target, Lucky Strike's Illusion-Breaking DMG is increased by 1%. This effect stacks up to 50 times and lasts for 5s. Available only in [...
- 271 Verdant Oracle - Nourish Burst -> buff 3056300 [Hard+Nightmare]: The damage area of the Blossom Charge summoned by Nourishing Seed is doubled, and its Illusion-Breaking DMG is increased by 1,000%. Available only in [Hard] ...
...
- 279 Wind Knight - Wind Gate Damage Buff -> buff 3051160 [Nightmare]: Cyclone Illusion-Breaking DMG +50%, and Great Wind Cyclone Illusion-Breaking DMG +100%. Available only in [Nightmare].
...
- 284 Wind Knight - Courage Crit Damage -> buff 3051210 [Nightmare]: Casting Vortex Strike consumes all Courage. For each point of Courage consumed, its Illusion-Breaking DMG is increased by 3%. Available only in [Nightmare].
...
- 287 Wind Knight - Sever Wind Summoning -> buff 3051240 [Nightmare]: When Azure Sever deals damage, it triggers an additional Tornado. This Tornado's Illusion-Breaking DMG is increased by 100%. Available only in [Nightmare].
...
- 289 Wind Knight - Extreme Instant Edge -> buff 3051260 [Hard+Nightmare]: Reduces the Sharp cost of Instant Edge to 1 and increases its Illusion-Breaking DMG by 50%. Available only in [Hard] and [Nightmare].
...
- 291 Wind Knight - Skyfall Recharge -> buff 3051280 [Hard+Nightmare]: Skyfall can now charge Sharp Impact, increasing its Illusion-Breaking DMG by 200%. Available only in [Hard] and [Nightmare].
...
- 293 Wind Knight - Instant Edge Sharp Damage -> buff 3051300 [Nightmare]: Instant Edge now consumes all Sharp, with each point consumed increasing its Illusion-Breaking DMG by an additional 10%. Available only in [Nightmare].
...
- 296 Shield Knight - Burning Judgment -> buff 3054210 [Hard+Nightmare]: Increases the Illusion-Breaking DMG of Judgment and Divine Strike by 50%. Available only in [Hard] and [Nightmare].
- 297 Shield Knight - Ultimate Judgment -> buff 3054220 [Hard+Nightmare]: After casting Scorching Judgment, Illusion-Breaking DMG dealt is increased by 50% for its duration. Available only in [Hard] and [Nightmare].
...
- 302 Shield Knight - Holy Strike -> buff 3054270 [Hard+Nightmare]: Special Attacks can now trigger Divine Strike. Divine Strike's Illusion-Breaking DMG is increased by 100%. Available only in [Hard] and [Nightmare].
- 303 Shield Knight - Swift Resolve -> buff 3054280 [Hard+Nightmare]: Reduces the CD of Radiance by 50%. During its effect, the Illusion-Breaking DMG dealt is increased by 20%. Available only in [Hard] and [Nightmare].
...
- 308 Shield Knight - Swift Crusade -> buff 3054340 [Hard+Nightmare]: Reduces the CD of Zeal Crusade by 50%. During its effect, the Illusion-Breaking DMG dealt is increased by 20%. Available only in [Hard] and [Nightmare].
- 309 Shield Knight - Holy Sigil Judgment -> buff 3054350 [Hard+Nightmare]: Judgment now consumes all Photon Energy. Vanguard Hunt's Crits now grant a Holy Sigil. Judgment's Illusion-Breaking DMG is increased by 50%. Available only i...
- 310 Heavy Guardian - Sandstone Reversal -> buff 3055200 [Nightmare]: Skills that consume Sand Crystals now restore them instead, and their Illusion-Breaking DMG is increased by 200%. Available only in [Nightmare].
- 311 Heavy Guardian - Mountain Shatter -> buff 3055210 [Hard+Nightmare]: Terra Sunder will consume all Sand Crystals. For each crystal consumed, its Illusion-Breaking DMG is increased by 50%. Available only in [Hard] and [Nightmare].
...
- 318 Heavy Guardian - Ultimate Rageblow -> buff 3055280 [Hard+Nightmare]: Casting Granite Fury guarantees Rageblow, and Rageblow's Illusion-Breaking DMG is increased by 100%. Available only in [Hard] and [Nightmare].
...
- 322 Heavy Guardian - Rageblow Defense -> buff 3055320 [Hard+Nightmare]: Granite Fury's cost is reduced by 1, and Granite Fury will extend the duration of Countercrush. Granite Fury's Illusion-Breaking DMG is increased by 100%. Av...
...
- 326 Beat Performer - Spotlight Finale -> buff 3057160 [Hard+Nightmare]: For 10s after casting Center Stage, Harmonic Anthem will be at maximum stacks, and its Illusion-Breaking DMG is increased by 300%. Available only in [Hard] a...
...
- 330 Beat Performer - Heroic Rhapsody -> buff 3057200 [Nightmare]: Illusion-Breaking DMG is increased by 50%. When Heroic Melody is active, Rhapsody of Flame will be active. Available only in [Nightmare].
...
- 334 Beat Performer - Passionate Exaltation -> buff 3057240 [Hard+Nightmare]: Passion Burst is permanently replaced with Passion Fury. This requires the Passion Fury Talent to be activated. Illusion-Breaking DMG is also increased by 30...
...
- 414 Twin Striker - Lucky Flame Slash -> buff 3060160 [Nightmare]: Every 1% of Luck provides a 0.2% (Stage 1)/0.1% (Stage 2)/0.05% (Stage 3) chance to trigger Formless Flame Slash. Available only in [Nightmare].
- 415 Twin Striker - Hellfire Axe Wind -> buff 3060170 [Hard+Nightmare]: When Axe Wind deals damage, triggers Hellfire Meteor (at most once when hitting multiple targets). Available only in [Hard] and [Nightmare].
- 416 Twin Striker - Axe Wind Enhancement -> buff 3060180 [Hard+Nightmare]: Reduces the Stamina cost of Axe Wind and adds an engulfing pull effect. Available only in [Hard] and [Nightmare].
- 417 Twin Striker - Assault Burst -> buff 3060190 [Nightmare]: For 5s after casting Blazing Assault, increases Crit Chance by 100% and Crit DMG by 30%. Available only in [Nightmare].
- 418 Twin Striker - Burning Flame Slash -> buff 3060200 [Nightmare]: Burn can trigger Formless Flame Slash, but the trigger chance is halved. Available only in [Nightmare].
- 419 Twin Striker - Axe Wind DMG Boost -> buff 3060210 [Hard+Nightmare]: When Axe Wind deals damage, increases Final DMG based on the number of Burn stacks on the target, with each stack granting 10%. Available only in [Hard] and ...
- 420 Twin Striker - Formless Buff -> buff 3060220 [Hard+Nightmare]: Each level of the Formless effect increases the highest among Crit, Haste, Luck, Mastery, and Versatility by 3%. Available only in [Hard] and [Nightmare].
- 421 Twin Striker - Fortunate Flame Slash -> buff 3060230 [Nightmare]: Increases the Final DMG of Formless Flame Slash by 40%, plus an additional 20% when hitting a target with Burn. Available only in [Nightmare].
- 422 Twin Striker - Element Buff -> buff 3060240 [Nightmare]: When Unbound Meteor or Falling Hellfire hits the primary target, grants an 8% Fire Bonus for 5s. Stacks up to 3 times. Available only in [Nightmare].
- 423 Twin Striker - Bleed -> buff 3060250 [Nightmare]: Flowing Splendor Slash deals bonus damage equal to 0.1% of the target's current HP. Available only in [Nightmare].
- 424 Twin Striker - Expertise Crit -> buff 3060260 [Hard+Nightmare]: Expertise Skill Crit DMG +40%. Available only in [Hard] and [Nightmare].
- 425 Twin Striker - Expertise DMG Boost -> buff 3060270 [Hard+Nightmare]: Increases Expertise Skill Illusion-Breaking DMG by 20%. Available only in [Hard] and [Nightmare].
- 426 Twin Striker - Hellfire Burst -> buff 3060280 [Nightmare]: During Endless Hellfire, doubles Crit DMG. Available only in [Nightmare].
- 427 Twin Striker - Hellfire CD Reduction -> buff 3060290 [Nightmare]: When Wildfire Dance hits the primary target, there is a 50% chance to reduce the CD of Endless Hellfire by 0.5s. Available only in [Nightmare].
- 428 Twin Striker - Powerful Strike -> buff 3060300 [Hard+Nightmare]: Flowing Splendor Slash transforms into Rare - Flowing Splendor Slash. Available only in [Hard] and [Nightmare].
- 429 Twin Striker - Flowing Splendor Charge -> buff 3060310 [Hard+Nightmare]: When the three-hit combo of Falling Hellfire is triggered, grants 1 Flowing Splendor Slash charge. Once fully charged, Flowing Splendor Slash triggers automa...
