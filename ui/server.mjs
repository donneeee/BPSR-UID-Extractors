...
const scripts = [
  ...
  {
    id: "season-phantom-factors",
    fileName: "SeasonPhantomFactors.gen",
    label: "Season Phantom Factors",
    description: "Promotes Phantom Factor probe evidence into parser modifier data.",
  ...
  },
  {
    ...
    description: "Builds parser modifier/source evidence from generated tables and probes.",
    outputFile: "EffectSources.json",
  },
  {
    id: "extract-icons",
